...
1. الحروف المعروضة كخيارات متناثرة أسفل الشاشة.
...
4. استخراج أطوال الكلمات المطلوبة بناءً على المربعات الفارغة המخصصة للإجابة (مثلاً إذا رأيت صفاً من 4 مربعات وصفاً من 5 مربعات، استخرج: [4, 5]). في الكلمات المتقاطعة، استخرج أطوال الكلمات المتقاطعة.
